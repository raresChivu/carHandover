...
export function useSignatureFunctions() {
  ...
  const { setIsDrawing, isDrawing, setSignatureType, setSignatures, signatureType, setShowSignature } = useAppStates();

interface StartDrawingEvent extends React.MouseEvent<HTMLCanvasElement, MouseEvent> {}
